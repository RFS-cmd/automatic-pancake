...
local PredictionValue = 0.11136642299
    ...
    mt.__namecall = newcclosure(function(...)
        local args = {...}
        if enabled and getnamecallmethod() == "FireServer" and args[2] == "UpdateMousePos" and Enabled and Plr.Character ~= nil then
    ...
    game:GetService("RunService").RenderStepped:Connect(function()
        if RESOVLER == true and Plr.Character ~= nil and enabled and Enabled then
